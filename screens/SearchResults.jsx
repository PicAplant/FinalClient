...
export default function SearchResults({ navigation, route }) {
  ...
  const similarPlantsArray = plants.map((item) => {
    ...
    if (
      item.plantName !== null &&
      item.plantScientificName !== plant.plantScientificName
    ) {
      ...
      item.plantIsProvidedHoneydew == plant.plantIsProvidedHoneydew
        ? (counter += 1)
        : "";
              ...
              <View style={styles.plantInfo}>
                ...
                {plant.plantIsToxic ? (
                  <View style={styles.iconView}>
                    ...
                    <Image
                      source={dangerIcon}
                      style={styles.searchResultsIcon}
                    ></Image>
                  </View>
                ) : (
                  ""
                ...
                {moreInfo && (
                  <Text style={{ writingDirection: "rtl", maxWidth: "99%" }}>
                    {plant.plantMoreInfo}
                  </Text>
                )}
              </View>
